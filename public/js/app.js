...
Vue.component('modal', __webpack_require__(32));
...
var app = new Vue({
    ...
    methods: {
        onLogin: function onLogin() {
            var login = this.loginModal.fields.login;
            var password = this.loginModal.fields.password;
            axios.post('/login', {
                login: login,
                password: password
        ...
        onSectionDelete: function onSectionDelete(id) {
        ...
        onTopicAdd: function onTopicAdd(section) {
        ...
        onTopicDelete: function onTopicDelete(id) {
        ...
        onPostAdd: function onPostAdd(topic) {
        ...
        onUserUpdate: function onUserUpdate() {
            var value = document.getElementById('user-role').value;
            if (value) {
...
Component.options.__file = "/home/lexuzieel/Projects/forum/resources/assets/js/components/Modal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0e216534", Component.options)
  } else {
    hotAPI.reload("data-v-0e216534", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    style: ({
      'max-width': _vm.maxWidth ? _vm.maxWidth : 'auto'
    })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0e216534", module.exports)
  }
}
